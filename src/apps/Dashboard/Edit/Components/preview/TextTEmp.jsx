    ...
    return (
        <div className="mt-0  m-0 p-0 sm:h-auto">
            <div className="mt-[5mm] sm:mt-[2mm]">
                ...
                <p id="TempTex" className="font-serif lg:text-[11.3pt] sm:text-[6.5pt]">{"3) This is a system generated document and does not require any signature."}</p>
                <p id="TempTex" className="font-serif lg:text-[11.3pt] mt-[5mm] sm:text-[5.5pt]">{"4) Self Certification by Lessee/MDO : I/We (Lessee/MDO/Q.P.) hereby declare that the above statements are correct and complete to best of my/our knowledge and belief. "}
                    <span id="TempTexBold1" className="font font-bold lg:text-[11.3pt] sm:text-[5.5pt]">
                        {`${OwnerName}.`}
                    </span>
                </p>
                <p id="TempTex" className="font-serif italic lg:text-[11.3pt] sm:text-[6.5pt]">{"Remarks :"}</p>
            </div>
            ...
            <p id="TempTexBold1" className=" grid justify-end font font-bold font-serif lg:text-[11.3pt]  mr-[5mm] sm:text-[6.5pt] sm:mr-[2mm] ">
                {`${OwnerName}`}</p>
            <p id="TempTexBold1" className="grid justify-end font font-bold font-serif lg:text-[11.3pt]  mr-[5mm] sm:text-[6.5pt] sm:mr-[2mm]">{`
             ${OwnerName === "Prasanta Kumar Hait" ? "PERMISSION HOLDER ID " : "Sand Processig Stock Id "} 
             ${SandID}`}</p>
